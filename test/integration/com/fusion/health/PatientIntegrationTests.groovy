...
class PatientIntegrationTests {
	...
	private def hawking = new Patient(lastName:"Hawking", middleName:"William",firstName:"Stephen",gender:Gender.Male,status:Status.Closed,birth:new Date().parse(TIME_PATTERN,"1942-01-08"),location:location)
